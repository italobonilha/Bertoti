...
public class Tela1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        botaoEntrar.setBackground(new java.awt.Color(105, 0, 0));
    ...
    private void botaoEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoEntrarActionPerformed
        try {
            ...
            Login pzzlogin = new Login();
            pzzlogin.setSenha(senha);
            pzzlogin.setUsuario(usuario);

            UsuarioDAO pzzlogindao = new UsuarioDAO();
            ResultSet rslogindao = pzzlogindao.autenticacaoUsuario(pzzlogin);
