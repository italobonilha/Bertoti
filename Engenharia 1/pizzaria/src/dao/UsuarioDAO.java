...
public class UsuarioDAO{
    ...
    public void cadastrarPizzaria (pizarriaDTO pzzDTO) {
        ...
        try {
            ...
            pstm.setString(1, pzzDTO.getNome());
            pstm.setString(2, pzzDTO.getMarca());
            pstm.setString(3, pzzDTO.getPreco());
            pstm.setString(4, pzzDTO.getTipo());
            pstm.setString(5, pzzDTO.getQuantidade());
    ...
    public ArrayList<pizzariaDTO> listarCanais() {
        ...
        try{
            ...
            while (rs.next()) {
                ...
                objpzzDTO.setNome(rs.getString("nome"));
                objpzzDTO.setMarca(rs.getString("quantidade"));
                objpzzDTO.setPreco(rs.getString("bebida"));
                objpzzDTO.setTipo(rs.getString("valor"));
